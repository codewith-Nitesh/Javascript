...
let myFirstData = ["Nitesh", "Nishant"];
let mySecondData = ["Vishal", "Naresh"];
let myThirdData = ["Jitender", "Kajal"];

let finalData = [...myFirstData, ...mySecondData, ...myThirdData];
...
const newFun = function (name) {
  return name;
};

console.log(newFun("Nitesh"));
